...
```mermaid
flowchart TD
    S["Start: 35% bad loans<br/>technically insolvent"] --> S0["Step 0 | Lock the door<br/>capital controls stay"]
    S0 --> S1["Step 1 | Recapitalize<br/>sovereign credit fills capital"]
    S1 --> S2["Step 2 | Strip<br/>AMC moves bad loans off-book"]
    S2 --> S3["Step 3 | Restructure<br/>risk control & accountability"]
    S3 --> S4["Step 4 | Open<br/>conditional, phased"]
    S4 --> END["Credit function restored"]
    S0 -.->|"skip: open into panic"| F1["Window closes"]
    S3 -.->|"skip: new money rots too"| F2["History repeats"]
```
